...
class View {
  ...
  populateBoard() {
    ...
    $("ul li").each( function(index) { $(this).append(`<img draggable="true" ondragstart="drag(event)" src=assets/images/${images[(index + Math.floor(Math.random() * 5)) % 5]} height="54px" >`)}).addClass('icon');
  }
